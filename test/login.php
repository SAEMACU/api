					...
					<div class="section-top-border">
						<div class="row">
							<div class="col-lg-8 col-md-8">
								<h3 class="mb-30" style="padding-left: 28px;">Login</h3>
								<form action="/api/api/objects/postmaster.php/validate" method="post">
									<div class="mt-10" style="padding-left: 28px;">
										<input type="text" required name="email_id" placeholder="Write Email Id Here" class="single-input">
									</div>
									<div class="mt-10" style="padding-left: 28px;">
										<input type="password" required name="pwd" placeholder="Write Pawssword Here" class="single-input">
									</div>
								<div class="mt-10" style="padding-left: 28px;">
								<input type="hidden" name="validate" value="1" >
									<input  type="submit" class="genric-btn radius">
							    </div>
								</form>
